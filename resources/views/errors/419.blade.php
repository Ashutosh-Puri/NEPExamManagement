  ...
  <div aria-labelledby="pageTitle" class="flex items-center justify-center h-screen bg-gray-100 dark:bg-dark dark:text-light">
    <div class="p-4 space-y-4">
      <div class="flex flex-col items-start space-y-3 sm:flex-row sm:space-y-0 sm:items-center sm:space-x-3">
        <p class="font-semibold text-danger-light text-9xl dark:text-danger">419</p>
        <div class="space-y-2">
          ...
          <p class="text-base font-normal text-gray-600 dark:text-gray-300">
            The page you're trying to access has expired. Please refresh the page and try again.
          </p>
          <p class="text-base font-normal text-gray-600 dark:text-gray-300">
            You may return to

<div class="m-2 overflow-hidden rounded border bg-white shadow dark:border-primary-darker dark:bg-darker">
  ...
  <div class="m-2 overflow-hidden rounded border bg-white shadow dark:border-primary-darker dark:bg-darker">
    <div class="bg-primary px-2 py-2 font-semibold text-white dark:text-light">
      Choose Your Modification Query <x-spinner />
    </div>
          ...
          @foreach ($documents as $doc)
            <div class="flex flex-col items-center space-x-1 border rounded-md border-primary m-2 ">
              ...
              <label class="block p-2 w-full">
                ...
                <x-input-file class="w-[95%]" name="uploaded_documents.{{ $doc->id }}" id="{{ $doc->id }}" wire:model.live="uploaded_documents.{{ $doc->id }}" accept="image/png, image/jpeg , image/jpg ,application/pdf" />

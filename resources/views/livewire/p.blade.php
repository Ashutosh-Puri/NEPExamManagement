    ...
    <body>
        <table border="1">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $pattern_class->id }}</td>
                    <td>
                        {{ $pattern_class->courseclass->classyear->classyear_name }}
                        {{ $pattern_class->courseclass->course->course_name }}
                        {{ $pattern_class->pattern->pattern_name }}
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        @livewire('c',['pattern_class'=>$pattern_class])
                    </td>
                </tr>
                    
                @endforeach
                {{ $pattern_classes->links() }}
            </tbody>
        </table>
    </body>
    </html>
...
{{-- <div>
  ...
  <div class="w-64">
    <select multiple x-data="multiselect" wire:model.live='ok' name="ok">

...
<button {!! $attributes->merge(['type' => 'button', 'class' => ' items-center justify-center rounded-md bg-yellow-700 py-1.5 shadow-lg inline-flex text-white px-2  cursor-pointer']) !!}>
    @if ($i)

<x-sidebar.sidebar>
  <x-sidebar.sidebar-link route="student" name="Home">
  ...
  @auth('student')
    @if (auth()->guard('student')->user()->is_profile_complete)
      ...
      <x-sidebar.sidebar-link route="student.dashboard" name="Dashboard">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" />
      </x-sidebar.sidebar-link>

      <x-sidebar.sidebar-link route="student.payments" name="Payments">
        <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
      </x-sidebar.sidebar-link>

      <x-sidebar.sidebar-link route="student.helpline" name="Helpline">
    ...
    @else
      <x-sidebar.sidebar-link route="student.profile" name="Profile">
    ...
    @endif
    <x-sidebar.logout-link route="student.logout" name="Logout">
  ...
  @else
    <x-sidebar.sidebar-link route="student.login" name="Login">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m3 0l3-3m0 0l-3-3m3 3H9" />
    </x-sidebar.sidebar-link>

    <x-sidebar.sidebar-link route="student.register" name="Register">
